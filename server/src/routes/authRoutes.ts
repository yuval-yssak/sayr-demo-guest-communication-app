...
import { clientGuestAppBaseURL, clientStaffAppBaseURL } from '../config/config'
...
const authRoutes = (app: Express) => {
  ...
  app.get(
    ...
    (req: Request, res: Response) => {
      ...
      res.redirect(`${clientGuestAppBaseURL}/after-google-login`)
    }
  )
  ...
  app.get('/:app/verify-email/:id', async (req, res): Promise<void> => {
