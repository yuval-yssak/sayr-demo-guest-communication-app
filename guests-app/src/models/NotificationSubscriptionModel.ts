...
export interface NotificationSubscriptionModelType
  extends Instance<typeof NotificationSubscriptionModel.Type> {}

/* A graphql query fragment builders for NotificationSubscriptionModel */
export {
  selectFromNotificationSubscription,
 ...
 */
export const NotificationSubscriptionModel = NotificationSubscriptionModelBase.actions(
  self => ({
