 ...
 */
export const AnnouncementResponseModelBase = ModelBase
  .named('AnnouncementResponse')
  .props({
    __typename: types.optional(types.literal("AnnouncementResponse"), "AnnouncementResponse"),
...
export class AnnouncementResponseModelSelector extends QueryBuilder {
  ...
  get valid() { return this.__attr(`valid`) }
...
export const announcementResponseModelPrimitives = selectFromAnnouncementResponse()._id.subject.body.image.valid.created_at.updated_at
