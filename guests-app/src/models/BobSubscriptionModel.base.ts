 ...
 */
export const BobSubscriptionModelBase = ModelBase.named('BobSubscription')
  .props({
    __typename: types.optional(
      types.literal('BobSubscription'),
      'BobSubscription'
    ),
...
export const bobSubscriptionModelPrimitives = selectFromBobSubscription()
