 ...
 */
export const NotificationSubscriptionModelBase = ModelBase
  .named('NotificationSubscription')
  .props({
    __typename: types.optional(types.literal("NotificationSubscription"), "NotificationSubscription"),
...
export const notificationSubscriptionModelPrimitives = selectFromNotificationSubscription().userAgent.endpoint.p256dhKey.authKey
