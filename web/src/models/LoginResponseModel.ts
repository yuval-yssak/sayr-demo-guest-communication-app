...
export interface LoginResponseModelType
  extends Instance<typeof LoginResponseModel.Type> {}

/* A graphql query fragment builders for LoginResponseModel */
export {
  selectFromLoginResponse,
 ...
 * LoginResponseModel
 */
export const LoginResponseModel = LoginResponseModelBase.actions(self => ({
